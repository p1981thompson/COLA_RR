...
f1~~1*f1
' 
powerfun<-function(Niter=1000,N.group1=325L,N.group2=325L)
{
...
ind[i]<-ifelse(probs[i]>0.05,0,1)
}
power<-mean(ind)
return(power)
}

powertab<-data.frame(N1=c(160,200,325,450),N2=c(490,450,325,450),power=rep(NA,4))
for(j in 1:4)
{
powertab[j,3]<-powerfun(1000,powertab[j,1],powertab[j,2])
}
